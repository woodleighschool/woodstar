...
func TestDerivedPackageMetadata(t *testing.T) {
	...
	request := plugin.ReconcileRequest{Prepared: true, Identity: plugin.Identity{Software: "Suite"}, Artifact: plugin.Artifact{Path: "leased.pkg", Format: "pkg"}, Facts: plugin.Facts{Subjects: []plugin.Subject{
