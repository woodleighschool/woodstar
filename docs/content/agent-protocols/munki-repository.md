...
| `GET`  | `/munki/pkgs/*`             | Redirect to a package artifact.                                   |
...
Catalog, package, and icon routes use the bearer secret but do not resolve a host. Their output is host-independent.
