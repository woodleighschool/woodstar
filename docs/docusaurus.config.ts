...
const config: Config = {
      ...
      "classic",
      {
        docs: {
          ...
          sidebarItemsGenerator: async ({ defaultSidebarItemsGenerator, ...args }) => {
            ...
            // The API reference has its own navbar menu (apiSidebar), so keep
            // its generated pages out of the autogenerated guide sidebar.
  ...
  } satisfies Preset.ThemeConfig & { api?: { hideSendButton?: boolean } },
};
