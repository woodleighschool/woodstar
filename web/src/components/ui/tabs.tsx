...
function TabsList({
  ...
  const { listRef, box } = useTabIndicator();
  ...
  return (
    ...
    >
      {variant === "default" ? (
        <span
          aria-hidden
          className="pointer-events-none absolute top-0 left-0 rounded-md bg-background shadow-sm transition-[transform,width,height,opacity] duration-300 ease-out dark:border dark:border-input dark:bg-input/30"
          style={{
            height: box?.height ?? 0,
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=default]/tabs-list:z-10 group-data-[variant=default]/tabs-list:bg-transparent group-data-[variant=default]/tabs-list:data-[state=active]:bg-transparent group-data-[variant=default]/tabs-list:data-[state=active]:shadow-none dark:group-data-[variant=default]/tabs-list:data-[state=active]:border-transparent dark:group-data-[variant=default]/tabs-list:data-[state=active]:bg-transparent",
