...
export function EnrollSecretsDialog({ trigger }: { trigger: React.ReactNode }) {
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Reusable shared secrets for device enrollment. Minimum 32 characters. Deleting a secret does not invalidate
        ...
        <SecretTable
          ...
          emptyDescription="Create a secret to allow hosts to enroll against this Woodstar deployment."
        />
