import type { SantaExecutionEvent, SantaFileAccessEvent } from "@lib/api";
import { enumOptions, type StatusMetadataMap } from "@lib/enum-metadata";

import type { SantaEventDecisionFilter } from "./queries";

export type SantaExecutionDecision = SantaExecutionEvent["decision"];
