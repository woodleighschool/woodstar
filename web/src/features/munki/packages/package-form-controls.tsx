...
export function VersionField({ form }: { form: PackageEditorForm }) {
  return (
    <form.Field name="version">
      {(field) => (
        <ValidatedFormField field={field} label="Version" htmlFor="munki-package-version" required>
          {(control) => (
            <Input
              {...control}
              name={field.name}
...
export function FormTextareaField({
  ...
  return (
    <form.Field name={name}>
      {(field) => (
        <ValidatedFormField field={field} label={label} htmlFor={id} description={description}>
          {(control) => (
            <Textarea
              {...control}
              id={id}
    ...
    <form.Field name="restart_action">
      {(field) => (
        <ValidatedFormField
          ...
          htmlFor="munki-package-restart-action"
        >
          {() => (
            <Select
