export const queryKeys = {
  ...
  entraUsers: (params?: unknown) => ["entra", "users", params ?? {}] as const,
  entraGroups: (params?: unknown) => ["entra", "groups", params ?? {}] as const,
  entraDepartments: (params?: unknown) => ["entra", "departments", params ?? {}] as const,
  ...
  munkiAssignment: (id: number | null) => ["munki", "assignments", id] as const,
