...
export function munkiSoftwareActionLabel(value: string | null | undefined) {
  if (!value) return "";
  return enumLabel(MUNKI_SOFTWARE_ACTIONS, value);
}
...
export function munkiSoftwareActionDescription(value: MunkiSoftwareAction) {
  return MUNKI_SOFTWARE_ACTIONS[value].description;
}
