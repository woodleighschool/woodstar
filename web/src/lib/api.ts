...
export type MunkiArtifactPage = API.MunkiArtifactPage;
export type MunkiAssignment = API.MunkiAssignment;
export type MunkiAssignmentMutation = API.MunkiAssignmentMutation;
export type MunkiAssignmentPage = API.MunkiAssignmentPage;
export type MunkiRelease = API.MunkiRelease;
export type MunkiReleaseMutation = API.MunkiReleaseMutation;
export type MunkiReleasePage = API.MunkiReleasePage;
export type MunkiSoftwareTitle = API.MunkiSoftwareTitle;
export type MunkiSoftwareTitleMutation = API.MunkiSoftwareTitleMutation;
export type MunkiSoftwareTitlePage = API.MunkiSoftwareTitlePage;
