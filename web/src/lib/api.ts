...
export type MunkiDeployment = API.MunkiDeployment;
export type MunkiDeploymentMutation = API.MunkiDeploymentMutation;
export type MunkiDeploymentPage = API.PageMunkiDeployment;
...
export type PackageMetadata = API.PackageMetadata;
