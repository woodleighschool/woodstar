...
export type EntraDepartment = API.EntraDepartment;
export type EntraGroup = API.EntraGroup;
export type EntraUser = API.EntraUser;
...
export type MunkiAssignmentPage = API.PageMunkiAssignment;
...
export type MunkiSoftwareTitleDetail = API.MunkiSoftwareTitleDetail;
export type MunkiSoftwareTitleMutation = API.MunkiSoftwareTitleMutation;
export type MunkiSoftwareTitlePage = API.PageMunkiSoftwareTitle;
