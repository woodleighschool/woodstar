...
/**
 * List software report
 */
export const listMunkiSoftwareReport = <ThrowOnError extends boolean = false>(options: Options<ListMunkiSoftwareReportData, ThrowOnError>): RequestResult<ListMunkiSoftwareReportResponses, ListMunkiSoftwareReportErrors, ThrowOnError> => (options.client ?? client).get<ListMunkiSoftwareReportResponses, ListMunkiSoftwareReportErrors, ThrowOnError>({
    querySerializer: { parameters: { status: { array: { explode: false } } } },
    security: [{
            in: 'cookie',
            name: 'woodstar_session',
