 ...
 */
export const getSession = <ThrowOnError extends boolean = false>(options?: Options<GetSessionData, ThrowOnError>): RequestResult<GetSessionResponses, GetSessionErrors, ThrowOnError> => (options?.client ?? client).get<GetSessionResponses, GetSessionErrors, ThrowOnError>({ url: '/api/auth/session', ...options });
 ...
 */
export const deleteHostUserAffinity = <ThrowOnError extends boolean = false>(options: Options<DeleteHostUserAffinityData, ThrowOnError>): RequestResult<DeleteHostUserAffinityResponses, DeleteHostUserAffinityErrors, ThrowOnError> => (options.client ?? client).delete<DeleteHostUserAffinityResponses, DeleteHostUserAffinityErrors, ThrowOnError>({ url: '/api/hosts/{id}/user-affinity', ...options });

/**
 * Set the host user affinity
 */
export const putHostUserAffinity = <ThrowOnError extends boolean = false>(options: Options<PutHostUserAffinityData, ThrowOnError>): RequestResult<PutHostUserAffinityResponses, PutHostUserAffinityErrors, ThrowOnError> => (options.client ?? client).put<PutHostUserAffinityResponses, PutHostUserAffinityErrors, ThrowOnError>({
...
/**
 * Serve an uploaded Munki icon
 */
export const getMunkiIconContent = <ThrowOnError extends boolean = false>(options: Options<GetMunkiIconContentData, ThrowOnError>): RequestResult<GetMunkiIconContentResponses, GetMunkiIconContentErrors, ThrowOnError> => (options.client ?? client).get<GetMunkiIconContentResponses, GetMunkiIconContentErrors, ThrowOnError>({ url: '/api/munki/icons/{object_id}/content', ...options });

/**
 * List Munki packages
 */
export const listMunkiPackages = <ThrowOnError extends boolean = false>(options?: Options<ListMunkiPackagesData, ThrowOnError>): RequestResult<ListMunkiPackagesResponses, ListMunkiPackagesErrors, ThrowOnError> => (options?.client ?? client).get<ListMunkiPackagesResponses, ListMunkiPackagesErrors, ThrowOnError>({ url: '/api/munki/packages', ...options });
...
/**
 * Create an uninstaller upload for a Munki package
 */
export const createMunkiPackageUninstallerUpload = <ThrowOnError extends boolean = false>(options: Options<CreateMunkiPackageUninstallerUploadData, ThrowOnError>): RequestResult<CreateMunkiPackageUninstallerUploadResponses, CreateMunkiPackageUninstallerUploadErrors, ThrowOnError> => (options.client ?? client).post<CreateMunkiPackageUninstallerUploadResponses, CreateMunkiPackageUninstallerUploadErrors, ThrowOnError>({
...
/**
 * Confirm and attach an uninstaller upload to a Munki package
 */
export const confirmMunkiPackageUninstallerUpload = <ThrowOnError extends boolean = false>(options: Options<ConfirmMunkiPackageUninstallerUploadData, ThrowOnError>): RequestResult<ConfirmMunkiPackageUninstallerUploadResponses, ConfirmMunkiPackageUninstallerUploadErrors, ThrowOnError> => (options.client ?? client).post<ConfirmMunkiPackageUninstallerUploadResponses, ConfirmMunkiPackageUninstallerUploadErrors, ThrowOnError>({ url: '/api/munki/packages/{id}/uninstaller/{object_id}/confirm', ...options });
 ...
 */
export const listOsqueryCheckHosts = <ThrowOnError extends boolean = false>(options: Options<ListOsqueryCheckHostsData, ThrowOnError>): RequestResult<ListOsqueryCheckHostsResponses, ListOsqueryCheckHostsErrors, ThrowOnError> => (options.client ?? client).get<ListOsqueryCheckHostsResponses, ListOsqueryCheckHostsErrors, ThrowOnError>({ url: '/api/osquery/checks/{id}/hosts', ...options });
...
/**
 * List Santa rule references
 */
export const listSantaRuleReferences = <ThrowOnError extends boolean = false>(options?: Options<ListSantaRuleReferencesData, ThrowOnError>): RequestResult<ListSantaRuleReferencesResponses, ListSantaRuleReferencesErrors, ThrowOnError> => (options?.client ?? client).get<ListSantaRuleReferencesResponses, ListSantaRuleReferencesErrors, ThrowOnError>({ url: '/api/santa/rule-references', ...options });
