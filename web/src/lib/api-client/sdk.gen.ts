...
/**
 * List assigned hosts for a software title
 */
export const listMunkiSoftwareHosts = <ThrowOnError extends boolean = false>(options: Options<ListMunkiSoftwareHostsData, ThrowOnError>): RequestResult<ListMunkiSoftwareHostsResponses, ListMunkiSoftwareHostsErrors, ThrowOnError> => (options.client ?? client).get<ListMunkiSoftwareHostsResponses, ListMunkiSoftwareHostsErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'woodstar_session',
            type: 'apiKey'
