...
/**
 * Update client resources from the builder
 */
export const updateMunkiClientResourcesBuilder = <ThrowOnError extends boolean = false>(options: Options<UpdateMunkiClientResourcesBuilderData, ThrowOnError>): RequestResult<UpdateMunkiClientResourcesBuilderResponses, UpdateMunkiClientResourcesBuilderErrors, ThrowOnError> => (options.client ?? client).put<UpdateMunkiClientResourcesBuilderResponses, UpdateMunkiClientResourcesBuilderErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'woodstar_session',
            type: 'apiKey'
...
/**
 * Publish a client resources archive
 */
export const publishMunkiClientResourcesArchive = <ThrowOnError extends boolean = false>(options: Options<PublishMunkiClientResourcesArchiveData, ThrowOnError>): RequestResult<PublishMunkiClientResourcesArchiveResponses, PublishMunkiClientResourcesArchiveErrors, ThrowOnError> => (options.client ?? client).put<PublishMunkiClientResourcesArchiveResponses, PublishMunkiClientResourcesArchiveErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'woodstar_session',
            type: 'apiKey'
