...
export function formatInterval(seconds: number): string {
  ...
  if (days >= 7 && seconds % 604800 === 0) return countLabel(seconds / 604800, "week");
  if (days > 0 && seconds % 86400 === 0) return countLabel(days, "day");
  if (hours > 0 && seconds % 3600 === 0) return countLabel(hours, "hour");
  if (minutes > 0 && seconds % 60 === 0) return countLabel(minutes, "minute");
