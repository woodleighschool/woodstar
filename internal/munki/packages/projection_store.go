...
type packageRow struct {
	...
	InstallerEnvironment         postgres.JSONSlice[PackageInstallerEnvironmentVariable]
	Installs                     postgres.JSONSlice[PackageInstallItem]
	Receipts                     postgres.JSONSlice[PackageReceipt]
	ItemsToCopy                  postgres.JSONSlice[PackageItemToCopy]
	Notes                        string
