...
const (
	...
	SantaExecutionDecisionBlockBinaryMismatch SantaExecutionDecision = "block_binary_mismatch"
	SantaExecutionDecisionAllowPlatform       SantaExecutionDecision = "allow_platform"
)
