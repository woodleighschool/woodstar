...
SET
    ...
    platform = COALESCE(sqlc.narg(platform)::platform, platform),
    osquery_platform = COALESCE(NULLIF(@osquery_platform::text, ''), osquery_platform),
    osquery_platform_like = COALESCE(NULLIF(@osquery_platform_like::text, ''), osquery_platform_like),
