...
ALTER TABLE santa_executables
    ...
    ADD COLUMN file_bundle_hash_millis BIGINT NOT NULL DEFAULT 0 CHECK (file_bundle_hash_millis >= 0),
    ADD COLUMN file_bundle_binary_count BIGINT NOT NULL DEFAULT 0 CHECK (file_bundle_binary_count >= 0),
    ADD COLUMN codesigning_flags BIGINT NOT NULL DEFAULT 0,
