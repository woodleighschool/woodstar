...
func santaEventsRouter(t *testing.T) *chi.Mux {
	...
	registerSantaEvents(humaAPI, eventsStore, discardLogger())
	return router
}
...
func TestSantaEventsListFiltersAndPaginates(t *testing.T) {
	...
	var blockedList api.Page[events.ExecutionEvent]
	...
	var executionList api.Page[events.ExecutionEvent]
	...
	var fileAccessList api.Page[events.FileAccessEvent]
